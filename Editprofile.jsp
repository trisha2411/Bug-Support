...
<div id="register">
<form action="EditServlet" name="f1" method="post">
...
%>
<tr><td>Employee ID:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=rs.getString(1) %></td></tr>
<tr><td>Employee Name:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=rs.getString(2) %></td></tr>
<tr><td>Employee Dept.:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="edept" value="<%=rs.getString(6)%>"></td></tr>
<tr><td>Employee Phone no.:&nbsp&nbsp<input type="text" name="eph" value="<%=rs.getString(3)%>"></td></tr>
<tr><td>Employee PC no:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="epc" value="<%=rs.getString(5) %>" ></td></tr>
<tr><td>Employee Address:&nbsp&nbsp&nbsp<input type="text" name="eadd" value="<%=rs.getString(4)%>"></td></tr>
