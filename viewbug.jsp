...
<caption align="top"><b><u><h2>LIST OF ADDED BUG IN COMPANY</h2></u></b></caption>
  ...
  <%   
  				...
  				PreparedStatement ps=con.prepareStatement("select *from addbug");
  				...
  				while(rs.next())
  				{
  					...
  					<tr><td><%= rs.getString(2)%> </td>
  						<td><a href="allocatetechperson.jsp?t=<% out.print(rs.getString(2)); %>"><%= rs.getString(7) %></a> </td>
