...
<caption align="top"><b><u><h2><%out.print(n);out.print("'s Profile"); %></h2></u></b></caption>
 ...
 <%         
	    ...
	    %>  
 					...
 					<tr><td>TECH ID</td><td><%= rs.getString(1)%> </td>
 					</tr><br>
 	                <tr><td>TECH NAME</td><td><%= rs.getString(2)%> </td>
 					    
 					</tr><br>
 						
  					<tr><td>TECH DEPT.</td><td><%= rs.getString(5)%> </td>
  					...
  					<tr><td>ADDRESS</td><td><%= rs.getString(4)%> </td>
  					     <td><a href="Edittechprofile.jsp">Edit</a></td>
  					</tr><br>
